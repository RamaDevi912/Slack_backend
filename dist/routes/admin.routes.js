...
import { getActivityAnalytics, getAllChannels, getAllUsers, getAllWorkspaces, getAuditLogs, getPlatformStats, getUserDetails, getWorkspaceDetails, promoteToAdmin, removeAdmin, } from '../controllers/admin.controller.js';
const router = Router();
...
router.get('/workspaces/:workspaceId/audit-logs', authenticate, isPlatformAdmin, getAuditLogs);
